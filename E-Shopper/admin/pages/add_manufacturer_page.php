...
if(isset($_POST['save_manufacturer'])){
	$message = $admin->saveManufacturer($_POST);
}
			...
			<form action="" method="post" class="form-horizontal">
			  <fieldset>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<textarea rows="5" cols="8" class="span6 typeahead" name="manufacturer_description"></textarea>
				  </div>
				</div>
				...
				<div class="form-actions">
				  <button type="submit" name="save_manufacturer" class="btn btn-primary">Save changes</button>
